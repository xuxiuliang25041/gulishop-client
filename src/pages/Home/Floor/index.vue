                    ...
                    <div class="tab-pane">
                        <div class="floor-1">
                            ...
                            <div class="floorBanner">
                                ...
                                <MySwiper :bannerList="floor.carouselList" :refName="'floor'"></MySwiper>
...
export default {
  ...
  props: ['floor'],
    ...
    /* mounted(){
        //因为floor的数据是home传递过来的 相当于静态数据    所以可以写在mounted中
   ...
   /*  watch:{
        floor:{
            immediate: true, //一开始要执行一次  因为传过来第一次就是完整的数据 ，nextTick不执行
            handler(){
                this.$nextTick(() => {
                     new Swiper (this.$refs.floorSwiper, {
                        // direction: 'vertical', // 垂直切换选项
