...
// 注册用户 请求 /api/user/passport/register  post  请求体参数， 需要phone，code，密码password
...
// 请求登录 返回的正常是一个token ， /api/user/passport/login  post  请求体参数， phone。 password
...
// 请求用户信息  /api/user/passport/auth/getUserInfo  get
